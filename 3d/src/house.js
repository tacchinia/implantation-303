...
export function buildHouse(M) {
  ...
  // terrasse de l'étage + coursive (platelage mélèze), escalier extérieur
  g.add(boxB(-1.14, 2.07, L1 - 0.2, L1 + 0.05, 7.7, LEN + 0.25, M.deck));
  g.add(boxB(-1.14, 0, L1 - 0.2, L1 + 0.05, 6.44, 7.7, M.deck));
